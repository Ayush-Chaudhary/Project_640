...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, help='path to the output directory', default = 'FlowFormerPlusPlus-main/datasets/Sintel/test')
    parser.add_argument('--vid_name', type=str, help='name of the video file', default='test_video')
